...
CREATE TABLE "Education" (
    "id" TEXT NOT NULL,
    "formalEducation" BOOLEAN NOT NULL DEFAULT true,
    "userId" TEXT NOT NULL,
    "currentcollege" TEXT,
    "degree" TEXT,
    "fieldofstudy" TEXT,
...
CREATE TABLE "Experience" (
    ...
    "startDate" TEXT,
    "endDate" TEXT,
    "description_how_you_describe_yourself" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE INDEX "Permission_communityId_idx" ON "Permission"("communityId");
